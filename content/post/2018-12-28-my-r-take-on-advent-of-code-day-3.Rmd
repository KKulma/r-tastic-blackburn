...
Now we have the dimensions, how do we go about determining the overlap?
...
Right, but how to do it in R? this is where `outer` funciton comes in handy. Let's take the first example:
